...
Tracked and updated by `/tutor` (see `.claude/skills/tutor/SKILL.md`) at the
end of every tutoring session. Read by the skill at the start of a session to
decide what to revisit. Not hand-edited outside of a tutor session.

| Concept | Reference page | Status | Last session |
|---|---|---|---|
| Returns and compounding | `reference/concepts/portfolio_return.md` | untested | — |
...
| TBA and the dollar roll | `reference/fixed_income/tba_and_dollar_roll.md` | untested | — |
| Specified pools | `reference/fixed_income/specified_pools.md` | untested | — |
| CMO/REMIC structuring | `reference/fixed_income/cmo_remic_structuring.md` | untested | — |
