...
def two_stage_ddm_value(dividend_now, high_growth, high_growth_years, terminal_growth, required_return):
    ...
    if required_return <= terminal_growth:
        raise ValueError("required_return must exceed terminal_growth for the terminal value to converge.")
    pv = 0.0
